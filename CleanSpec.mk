...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/gee-common/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/gee-common/obj/EXECUTABLES/charger_touch_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/symbols/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/obj/NOTICE_FILES/src/system/bin/charger_touch.txt)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/gee-common/root/default.prop)
